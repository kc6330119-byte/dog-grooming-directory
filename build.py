...
def build_netlify_redirects():
    """Generate dist/_redirects with .html → extensionless 301s.

    Placeholder interpolation is unreliable in netlify.toml, so these
    rules live in the _redirects file format where :slug works correctly.
    The trailing `!` flag is force=true (redirect even if the file exists).
    """
    rules = """# .html → extensionless 301 redirects (canonical URL cleanup)
# Generated by build.py — do not edit by hand.

/groomer/:slug.html                  /groomer/:slug                  301!
/state/:state_slug/:city_slug.html   /state/:state_slug/:city_slug   301!
/state/:slug.html                    /state/:slug                    301!
/category/:slug.html                 /category/:slug                 301!
...
/editorial-standards.html  /editorial-standards  301!
/submit.html               /submit               301!
/blog.html                 /blog                 301!
/dog-grooming-guide.html   /dog-grooming-guide   301!
